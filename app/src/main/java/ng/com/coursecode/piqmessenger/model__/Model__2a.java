...
public class Model__2a {
    ...
    // @SerializedName("data")
    public List<Model__2a> data;

    // @SerializedName("pagination")
    public Model__2a pagination;
    ...
    private ArrayList<Status_tab> statData;
    ...
    public Model__2a getReciv_data() {
        return reciv_data;
    }

    public void setReciv_data(Model__2a reciv_data) {
        this.reciv_data = reciv_data;
    }

    public Model__2a getAuth_data() {
        return auth_data;
    }

    public void setAuth_data(Model__2a auth_data) {
    ...
    public List<Model__2a> getData() {
        return data;
    }

    public void setData(List<Model__2a> data) {
        this.data = data;
    }

    public Model__2a getPagination() {
        return pagination;
    }

    public void setPagination(Model__2a pagination) {
    ...
    public void setStatData(ArrayList<Status_tab> statData) {
    ...
    public ArrayList<Status_tab> getStatData() {
        return statData;
    }
