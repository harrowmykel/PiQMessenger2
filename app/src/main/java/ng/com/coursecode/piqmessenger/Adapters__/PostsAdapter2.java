...
public class PostsAdapter2 extends RecyclerView.Adapter<PostsViewHolder> {
...
//    }
    ...
    public PostsAdapter2(List<Posts_tab> model_list_, PostItemClicked postItemClicked_) {
        super();
...
//            holder.bind(messages, postItemClicked, position);
            ...
            if(!image.isEmpty()){
                ...
                Piccassa.load(context, image, R.drawable.nosong, R.drawable.empty, holder.posts_image);
             }else{
                holder.posts_image.setVisibility(View.GONE);
            }

            if(!(messages.getLiked()).equals("0")){
