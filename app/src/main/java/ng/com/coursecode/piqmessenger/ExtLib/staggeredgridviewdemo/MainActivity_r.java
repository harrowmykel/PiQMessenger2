...
public class MainActivity_r extends PiccMaqCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		StaggeredAdapter adapter = new StaggeredAdapter(MainActivity_r.this, R.id.imageView1, urls);
//		StaggeredAdapter adapter = new StaggeredAdapter(MainActivity_r.this, R.id.imageView1, url s_);
